...
import gym
import numpy as np
from block_transfer_vision_randomiseStart_HER import dVRKBlockVisionEnv
import os
...
model = model_class("MultiInputPolicy",env, buffer_size=50000, replay_buffer_class=HerReplayBuffer,
