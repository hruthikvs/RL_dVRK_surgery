# -*- coding: utf-8 -*-
"""
Created on Tue Nov  1 15:31:52 2022
...
import gym
import numpy as np
from Peg_transfer_Vision_new import dVRKCopeliaVisionEnv
import os
...
env = dVRKCopeliaVisionEnv(maxsteps=MAX_EP_LEN)
...
model = DDPG("MultiInputPolicy",env, buffer_size=10000, replay_buffer_class=HerReplayBuffer,
